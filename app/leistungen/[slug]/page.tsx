...
function getMetadata(slug: string): Metadata {
  const metadataMap: Record<string, Metadata> = {
    ...
    'fernseher-einrichtung': {
      ...
      alternates: { canonical: "https://mira-technikwelt.de/leistungen/fernseher-einrichtung" }
    },
    ...
    'computer-laptop-einrichtung': {
      ...
      alternates: { canonical: "https://mira-technikwelt.de/leistungen/computer-laptop-einrichtung" }
    },
    ...
    'router-wlan-einrichtung': {
      ...
      alternates: { canonical: "https://mira-technikwelt.de/leistungen/router-wlan-einrichtung" }
    },
    ...
    'smart-home-einrichtung': {
      ...
      alternates: { canonical: "https://mira-technikwelt.de/leistungen/smart-home-einrichtung" }
    },
    ...
    'smartphone-tablet-einrichtung': {
      ...
      alternates: { canonical: "https://mira-technikwelt.de/leistungen/smartphone-tablet-einrichtung" }
    },
    ...
    'vor-ort-beratung-analyse': {
      ...
      alternates: { canonical: "https://mira-technikwelt.de/leistungen/vor-ort-beratung-analyse" }
    },
    ...
    'vertragspruefung-tarifvergleich': {
      ...
      alternates: { canonical: "https://mira-technikwelt.de/leistungen/vertragspruefung-tarifvergleich" }
    },
    ...
    'gaming-pc-beratung': {
      ...
      alternates: { canonical: "https://mira-technikwelt.de/leistungen/gaming-pc-beratung" }
    },
    ...
    'gaming-pc-aufbau-installation': {
      ...
      alternates: { canonical: "https://mira-technikwelt.de/leistungen/gaming-pc-aufbau-installation" }
    },
    ...
    'online-pc-support': {
      ...
      alternates: { canonical: "https://mira-technikwelt.de/leistungen/online-pc-support" }
    },
    ...
    'geraetekauf-im-auftrag': {
      ...
      alternates: { canonical: "https://mira-technikwelt.de/leistungen/geraetekauf-im-auftrag" }
    },
    ...
    'entsorgung-altgeraete': {
      ...
      alternates: { canonical: "https://mira-technikwelt.de/leistungen/entsorgung-altgeraete" }
    },
    ...
    'komplettloesung-technikpaket': {
      ...
      alternates: { canonical: "https://mira-technikwelt.de/leistungen/komplettloesung-technikpaket" }
    }
  };
